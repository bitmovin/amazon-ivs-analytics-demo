...
export type I18nStrings = Partial<
	Record<keyof BoardProps["i18nStrings"], string>
>;
			...
			<LazyBoard
				...
				i18nStrings={{
					liveAnnouncementDndCommitted: () =>
						props.i18nStrings?.liveAnnouncementDndCommitted ?? "",
					liveAnnouncementDndDiscarded: () =>
						props.i18nStrings?.liveAnnouncementDndDiscarded ?? "",
					...
					navigationItemAriaLabel: () =>
						props.i18nStrings?.liveAnnouncementDndDiscarded ?? "",
					navigationAriaLabel:
						props.i18nStrings?.navigationAriaLabel ?? "",
