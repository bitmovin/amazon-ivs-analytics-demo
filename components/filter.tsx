...
export default function Filter<V extends string | number, const A extends AttributeKey>(props: { field: A } & Ops<V>) {
  return {
...
export type FilterElement<
  ...
  A extends AttributeKey = AttributeKey
> = ReturnType<typeof Filter<V, A>>;
