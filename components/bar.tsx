...
import type { AttributeKey, QueryType } from "@/server/bitmovin";
...
export default function Bar<const K extends QueryType, const P extends BarProps<K>>(props: P): BarElement<K> {
  return {
    type: null,
    key: null,
    props,
